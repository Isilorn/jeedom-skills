...
| `references/plugin-agenda.md` | Plugin Agenda : événements, calendriers | 🔄 J3 |
| `references/plugin-script.md` | Plugin Script : types, exécution | 🔄 J3 |
| `references/plugin-generic-pattern.md` | Pattern d'inspection générique (tous autres plugins) | 🔄 J3 |
